  ...
  return (
    <>
      ...
      <motion.div className="app__skills-desc" whileInView={{opacity:[0,1]}} transition={{duration: 1}} viewport={{once: true}}>
        ...
        <p className="p-text">I am good at web development and machine learning. I build websites in the MERN stack. I am also good with other technologies such as git, figma, scss, bootstrap, tailwind etc. I put good efforts in optimizing the code, so that websites run efficiently. I always strive to make the functionalities better. I have used SQL and NoSQL based databases. I also have experience in AI/ML related works. I use Python for AI/ML and DL related tasks. I am also interested in blockchain technology, and I am currently learning more about it.</p>
      </motion.div>
